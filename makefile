...
$BvgerIlia$O:	$BvgerIlia.c src/vgerIlia.md.pre.c src/vgerIlia.md.post.c;	$(CC) $(CFLAGS) -c -Isrc -o $@ $BvgerIlia.c
...
$BvgerIlia.c:	$Blburg$E src/vgerIlia.md; $Blburg src/vgerIlia.md $@
...
clean::		testclean
		$(RM) $B*$O
		$(RM) $Bdagcheck.c $Balpha.c $Bmips.c $Bx86.c $Bsparc.c $Bx86linux.c $BvgerIlia.c
